...
def esmm_model_fn(features, labels, mode, params):
  ...
  if mode == tf.estimator.ModeKeys.PREDICT:
    ...
    ctr_head = binary_class_head.BinaryClassHead(weight_column=params['weight_columns'], name='ctr')
    ctcvr_head = binary_class_head.BinaryClassHead(name='ctcvr')
    ...
    #reg_loss = ops.get_collection(tf.GraphKeys.REGULARIZATION_LOSSES)
    ...
    head = multi_head.MultiHead([ctr_head, ctcvr_head])
